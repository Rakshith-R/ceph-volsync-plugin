...
func TestSetSnapshotStatus_Nil(t *testing.T) {
	t.Parallel()
	m := newTestMover(t, true, constant.MoverTypeCephFS)
	ctx := t.Context()
...
func TestSetSnapshotStatus_Updates(t *testing.T) {
	...
	m := newTestMover(t, true, constant.MoverTypeCephFS, snap)
	ctx := t.Context()
...
func TestListSnapshotsWithStatus(t *testing.T) {
	...
	m = newTestMover(t, true, constant.MoverTypeCephFS, snap1, snap2, snap3)
	ctx := t.Context()
...
func TestTransitionSnapshotStatuses(t *testing.T) {
	...
	m = newTestMover(t, true, constant.MoverTypeCephFS, current, prev)
	ctx := t.Context()
