...
func newCephFSWorker(logger logr.Logger, workerType string, srcCfg common.SourceConfig, dstCfg common.DestinationConfig) (common.Worker, error) {
	switch workerType {
...
func newRBDWorker(logger logr.Logger, workerType string, srcCfg common.SourceConfig, dstCfg common.DestinationConfig) (common.Worker, error) {
	switch workerType {
	case string(constant.WorkerSource):
